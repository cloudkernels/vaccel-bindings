...
#[no_mangle]
pub extern "C" fn torch_model_load(
...
#[no_mangle]
pub extern "C" fn torch_session_delete(
    client_ptr: *const VsockClient,
    model_id: ffi::vaccel_id_t,
    sess_id: u32,
) -> i32 {
...
#[no_mangle]
pub extern "C" fn torch_model_run(
    client_ptr: *const VsockClient,
    model_id: ffi::vaccel_id_t,
    sess_id: u32,
    run_options_ptr: *mut ffi::vaccel_torch_buffer,
    in_nodes_ptr: *mut ffi::vaccel_torch_node,
    in_tensors_ptr: *const *mut ffi::vaccel_torch_tensor,
    nr_inputs: usize,
    out_nodes_ptr: *mut ffi::vaccel_torch_node,
