...
pub const VACCELRT_VERSION: &[u8; 24usize] = b"v0.5.0-4-g058a41c-dirty\0";
...
extern "C" {
    pub fn vaccel_prof_region_start_name(
...
extern "C" {
    pub fn vaccel_prof_region_stop_name(
        region: *mut vaccel_prof_region,
        size: ::std::os::raw::c_int,
        name: *const ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    pub fn vaccel_prof_region_print_all(
        region: *mut vaccel_prof_region,
        size: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn vaccel_prof_region_print_all_to_buf(
